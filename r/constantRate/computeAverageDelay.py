...
for run in runs:
    ...
    f_in = open ("/home/rudy/ns-dev/experimentResult/results/congestion-zoom-ndn-deviationRouting2Rtt-%d-app-delays-trace.log" % run , "r")
    delay_sum=0
    all_count=0
    for line in f_in:
        a=line.split('\t')
    ...
    f_in = open ("/home/rudy/ns-dev/experimentResult/results/congestion-zoom-ndn-deviationRouting2-%d-app-delays-trace.log" % run , "r")
    delay_sum=0
    all_count=0
    for line in f_in:
        a=line.split('\t')
